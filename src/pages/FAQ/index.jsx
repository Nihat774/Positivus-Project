  ...
  return (
    <section className="flex flex-col gap-5 md:gap-20" id="pricing">
      <div className="flex md:flex-row flex-col gap-5 md:gap-10 items-center">
        ...
        <p className="text-center md:text-start w-full md:w-[20vw]">
        ...
        {faq.map((item) => {
          ...
          return (
            <div
              ...
              } border flex flex-col  px-[20px] md:px-[60px] cart-shadow transition-colors duration-300`}
            >
              <div className="flex items-center justify-between min-h-[70px] md:min-h-[130px]">
                <div className="flex items-center gap-4 font-semibold">
                  <p className="text-3xl md:text-5xl">0{item.number}</p>
              ...
              >
                <hr className="w-full h-[2px] bg-black md:mb-4" />
